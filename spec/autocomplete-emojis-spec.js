...
describe("Emojis autocompletions", function() {
  ...
  beforeEach(function() {
    ...
    runs(() => provider = atom.packages.getActivePackage('autocomplete-emojis-plus').mainModule.getProvider());

    return waitsFor(() => Object.keys(provider.properties).length > 0);
  });

  Object.keys(packagesToTest).forEach(packageLabel =>
    describe(`${packageLabel} files`, function() {
      beforeEach(function() {
...
`
  ...
  return describe('when the autocomplete-emojis-plus:showCheatSheet event is triggered', function() {
